function loadButton(options) {
  ...
  var ButtonWidth = (!options || !options.width) ? currentScript.getAttribute("button-width") : options.width;
  var ButtonHeight = (!options || !options.height) ? currentScript.getAttribute("button-height") : options.height;
  ...
  var elementId = (!options || !options.elementId) ? 'div2' : options.elementId;
  ...
  // SVG Icons URL	
  SvgUrl = "/img/button-icons-" + ButtonVariation;
  SvgUrlBtn = "/img/buttons-" + ButtonVariation;
  ...
  var DivWidt = document.getElementById(elementId).getBoundingClientRect().width;
  var DivHeight = document.getElementById(elementId).getBoundingClientRect().height;
  ...
  if (result < 0.35) {
    ...
    //document.getElementById(elementId).style.height = "304px";
    //loadSvg("#surveybot-svg", SvgUrl);
    loadSvg("#surveybot-svg", SvgUrl + ".svg");
    loadSvgBtn("#surveybot-link", SvgUrlBtn);
    // Count Title FOnt
